...
local Config = {
    ...
    Scripts = {
        ...
        {Name = "Set Car Collab", Icon = "Main", URL = "https://raw.githubusercontent.com/Anonymous9x-oss/Anonymous9xProjectv1/refs/heads/main/setcar.lua", Desc = "special collab with FIQQZR7"},
...
local function ShowWelcomeNotification()
    ...
    -- Animasi loading 4 detik lalu fade out smooth
